...
Other research can also be conducted that improves the useability of the application, provide a higher security level, creating a single application by merging the \dotnet server and UI. 
